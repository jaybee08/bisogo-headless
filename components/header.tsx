...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-[color:var(--color-border)] bg-white/90 backdrop-blur supports-[backdrop-filter]:bg-white/70">
      {/* Use container BUT center the logo on mobile by using a 3-column grid on small screens */}
      <div className="container h-16 px-4 sm:px-6 lg:px-8">
        <div className="grid h-16 grid-cols-[40px_1fr_40px] items-center sm:flex sm:items-center sm:justify-between sm:gap-3">
          {/* Left */}
          <div className="flex items-center justify-start sm:min-w-0 sm:gap-6">
            {/* Mobile menu button */}
            ...
            {data?.user ? (
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button variant="ghost" className="hidden h-9 w-9 rounded-full p-0 sm:inline-flex">
